...
<SCRIPT language=javascript>
	...
	$(function(){
		//发送异步请求，获取所有客户
		var url = "${pageContext.request.contextPath}/customer_findByAll.action";
		$.post(url,function(data){
			$(data).each(function(i,n){
				//获取主外键
				var lid = "${model.customer.cust_id}";
				if(n.cust_id == lid){
...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/linkman_findByPage.action" method="post" onsubmit="return checkForm()">
